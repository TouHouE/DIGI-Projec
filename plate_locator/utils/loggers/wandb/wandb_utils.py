...
from test.utils import LoadImagesAndLabels
from test.utils import img2label_paths
from test.utils import check_dataset, check_file
...
class WandbLogger():
    ...
    def log_model(self, path, opt, epoch, fitness_score, best_model=False):
        ...
        print("Saving models artifact on epoch ", epoch + 1)
